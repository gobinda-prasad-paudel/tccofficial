...
const ProjectsSection = ({ isDesktop }: IDesktop) => {
  ...
  const renderSectionTitle = (): React.ReactNode => (
    ...
    >
      ...
      <h1 className="section-heading seq mt-2">Our Works</h1>
      <h2 className="text-2xl md:max-w-3xl w-full seq max-w-sm mt-2">
      We have been actively involved in various kinds of innovation, contributing to projects in frontend development, competitive programming, article writing, open source, and motion graphics.
