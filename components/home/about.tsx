...
>
  The Computer Council is composed of passionate computer enthusiasts and
  technically-minded hobbyists who serve as executive members.{" "}
</span>
<span
  className={`about-2 leading-tight ${willChange ? "will-change-opacity" : ""}`}
>
  Their collective vision is to provide students with exposure to the latest
  advancements in computer technology, fostering an environment that encourages learning.
  {" "}
</span>
