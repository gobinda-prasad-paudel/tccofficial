...
const HERO_STYLES = {
  ...
  BG_WRAPPER:
    " flex items-center  flex-col content-centerabsolute hero-bg right-0 md:bottom-0 bottom-8 -z-1 md:w-3/4 w-full scale-125 sm:scale-100 flex items-end",
  TYPED_SPAN: "text-sm sm:text-1xl md:text-2xl seq",
};
    ...
    <div className={HERO_STYLES.CONTENT}>
      ...
      <div className="flex seq">
        <Button
          ...
          href="https://www.trinity.edu.np/publications
        "
        ></Button>
        <Button
          classes="ml-3"
